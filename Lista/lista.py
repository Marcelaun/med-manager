...
lista_pacientes.append(patient)
lista_pacientes.append(patient2)
lista_pacientes.append(patient3)
lista_pacientes.display()
lista_pacientes.pesquisa_paciente(cpf)
lista_pacientes.remover_cadastro(patient)
lista_pacientes.display()
...
lista_medicos.pesquisa_medico(cpf_medico)

print(lista_medicos.pesquisa_medicos_por_area_atuacao(area_de_atuacao))
lista_medicos.remover_cadastro(medic)
lista_medicos.display()
